...
#ifndef XSF_HELP12_H_INCLUDED
#define XSF_HELP12_H_INCLUDED
...
namespace XboxSampleFramework
{
    ...
    class Help 
    {
        ...
        D3DResourcePtr m_spBackgroundTexture;
    ...
    public:
        ...
        void Initialize(_In_ const SampleFramework* const pSample);
        void Initialize(_In_ const SampleFramework* const pSample, UINT frameWidth, UINT frameHeight);
        void Shutdown();
        ...
        void Render(_In_opt_ const D3D12_VIEWPORT* pViewport = nullptr);
    ...
    private:
        ...
        void LoadFonts(_In_ const SampleFramework* const pSample);
        void DestroyFonts();
        void LayoutCallouts();
